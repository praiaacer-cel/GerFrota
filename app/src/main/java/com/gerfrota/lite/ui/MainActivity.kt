...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ✅ Migração do banco antigo (Flutter) — herdada do antigo Nav.kt
            ...
            GerFrotaTheme {
                ...
                NavHost(nav, if (prefs.getBoolean("logado", false)) "dashboard" else "login") {
                    ...
                    composable("adiantamentos/{id}") { b ->
                        AdiantamentosScreen(b.arguments?.getLong("id") ?: -1, nav)
                    }
                    ...
                    composable("conjuntos") {
                        ConjuntosListScreen(
                            ...
                            onEditar = { id -> nav.navigate("conjunto_form/$id") },
                    ...
                    composable("viagem_form/{unidadeId}/{viagemId}") { b ->
                        ViagemFormScreen(
                            ...
                            nav                      // ✅ NavController como 3º parâmetro (sem lambda)
                        )
                    }
